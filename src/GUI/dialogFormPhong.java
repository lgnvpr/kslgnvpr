 ...
 * @author LGNV
 */
public class dialogFormPhong extends javax.swing.JDialog {

    /**
     * Creates new form FormPhong
     */
    public dialogFormPhong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        css();
    ...
    public void css(){
        ...
        cbbKhuVuc.getEditor().getEditorComponent().setBackground(Color.white);
    }
    ...
    private void initComponents() {
        ...
        lgnvPanel1.add(txtTenPhong, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 138, 285, 41));

        jLabel2.setText("Tình trạng");
        lgnvPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, 211, -1));
        ...
        lgnvPanel1.add(cbbKhuVuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 220, 290, 32));
        ...
        lgnvPanel1.add(cbbLoaiPhong, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 280, 290, 32));
        ...
        lgnvPanel1.add(cbbTinhTrang, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 340, 290, 32));

        jLabel4.setText("Mô Tả");
        lgnvPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 380, 211, -1));

        txtMoTa.setLGNV_placeholderText("Nhập Tên Phòng");
        lgnvPanel1.add(txtMoTa, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 400, 285, 41));
        ...
        lgnvPanel1.add(lblErrorMoTa, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, 285, -1));
        ...
        lgnvPanel1.add(btnThem, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 470, 194, 79));
        ...
        lgnvPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 70, 38, 32));

        jLabel6.setText("Tên Phòng");
        lgnvPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 113, 211, -1));

        jLabel7.setText("Khu Vực");
        lgnvPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 200, 211, -1));
        ...
        lgnvPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 211, -1));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if(checkNew){
            BLL_Phong.insert(BLL_Phong.getDataForm());
        }
        else {
            BLL_Phong.update(BLL_Phong.getDataForm());
        }
        
        this.setVisible(false);
        BLL_Phong.getALLData();
    ...
    public void checkNew(boolean  check ){
        ...
        if(checkNew){
            ...
            ID = BLL_Phong.getIDTable();
            BLL_Phong.setDataToForm(ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogFormPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogFormPhong dialog = new dialogFormPhong(new javax.swing.JFrame(), true);
