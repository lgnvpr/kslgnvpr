 ...
 * @author LGNV
 */
public class pnlManagerLoaiPhong extends javax.swing.JPanel {

    /**
     * Creates new form pnlManagerKhachHang
     */
    public pnlManagerLoaiPhong() {
        initComponents();
        css();
    }
    private void css(){
    ...
    private void initComponents() {
        ...
        scroll.setViewportView(tblLoaiPhong);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        BLL.BLL_LoaiPhong.setDataToCombobox(main.dialogLocLoaiPhong.cbbLoaiPhong, true);
        main.dialogLocLoaiPhong.setVisible(true);
    }//GEN-LAST:event_btnSuaActionPerformed

    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        main.dialogFormLoaiPhong.checkNew(true);
        compile();
    ...
    private void tblLoaiPhongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLoaiPhongMouseClicked
        if(evt.getClickCount() >=2){
            main.dialogFormLoaiPhong.checkNew(false);
            compile();
        }
